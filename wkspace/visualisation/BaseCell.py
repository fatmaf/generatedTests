    ...
    def draw(self):
        ...
        if self.master != None :
            ...
            if self.isGoalPos:
                ...
                goalfill = fillcolor #Cell.FILL_COLORS[GuiState.GOALS]
            ...
            if self.isGoalPos:
                starCords = self.getStarPoints(xc,yc,10,5)
                self.master.create_polygon(starCords,fill=goalfill,outline=Cell.BORDER_COLORS[GuiState.GOALS])
